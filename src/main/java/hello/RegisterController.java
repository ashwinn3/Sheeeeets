...
public class RegisterController {
    ...
    public Response register(@RequestParam(value = "username", defaultValue="err") String username, @RequestParam(value = "password", defaultValue = "perr") String password) {
        try {
            ...
            DBConnect.executeUpdate("INSERT INTO SheetsDB.User (username, password) VALUES " +
